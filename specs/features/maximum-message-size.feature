...
Scenario: Change Maximum message size to greater then 50MB
    ...
    Then The Field notification error: Please enter a value less than or equal to 50 
	And System Settings could not be save, please check your input is displayed 
...
Scenario: Send Mail over maximum message size
	...
	And mail is not transmitted to the recepient
