...
Feature: FileRelease
	...
	Scenario: Request the release of a held file to recipient via Portal
		Given I have a held file due to a set policy
		And I open the File Details screen from the transaction log
		When I enter the recipient mailbox and click Request Release
